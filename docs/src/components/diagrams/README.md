...
style. Homepage-style inline SVG (`grepify.github.io/src/pages/index.astro`)
...
| Peach round-cornered container | A **Grepify App** (hosts other elements) | `AppContainer` |
...
│   ├── AppContainer.astro          # peach container, Grepify App
