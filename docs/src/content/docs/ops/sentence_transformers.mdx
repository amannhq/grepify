...
Here's a complete example of a text embedding pipeline (based on the [text_embedding example](https://github.com/grepify/grepify/tree/main/examples/text_embedding)):
