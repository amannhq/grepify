...
---
The `grepify.ops.text` module provides operations for text processing.

```python
from grepify.ops.text import RecursiveSplitter, SeparatorSplitter
```
...
```python
from grepify.ops.text import detect_code_language
...
```python
from grepify.ops.text import SeparatorSplitter
...
```python
from grepify.ops.code import CodePattern, CodeSource
...
```python
from grepify.ops.text import CustomLanguageConfig, RecursiveSplitter
