...
3. Create a `pdf_files/` directory and add your PDF files:
    ...
    mkdir pdf_files
    ```
    You can use any local PDF files, or grab a few sample PDFs of your own to drop into this folder.
...
- Browse more [examples](https://github.com/amannhq/grepify/tree/main/examples) for real-world patterns (text embedding, RAG, knowledge graphs)
