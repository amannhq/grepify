...
See `_TableKey` in [`grepify/connectors/postgres/_target.py`](https://github.com/grepify/grepify/blob/main/python/grepify/connectors/postgres/_target.py) and [`grepify/connectors/surrealdb/_target.py`](https://github.com/grepify/grepify/blob/main/python/grepify/connectors/surrealdb/_target.py) for reference implementations.
...
- [`grepify/connectors/localfs/target.py`](https://github.com/grepify/grepify/blob/main/python/grepify/connectors/localfs/_target.py) — File system targets
- [`grepify/connectors/postgres/target.py`](https://github.com/grepify/grepify/blob/main/python/grepify/connectors/postgres/_target.py) — PostgreSQL tables and rows
