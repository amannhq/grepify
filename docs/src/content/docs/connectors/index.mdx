...
description: >
  The built-in connectors that move data in and out of a Grepify flow — object
  stores, message streams, and relational, vector, and graph databases. Many work
  as a source, a target, or both.
---
A *connector* links a Grepify flow to an external system. It plays one or both of two roles:
