...
```python
from grepify.connectors import oci_object_storage
```
...
```bash
pip install grepify[oci_object_storage]
```
...
from grepify.connectors import kafka, oci_object_storage, localfs
