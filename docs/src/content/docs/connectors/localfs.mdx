...
The `localfs` connector provides target state APIs for writing files. Grepify tracks what files should exist and automatically handles creation, updates, and deletion.
