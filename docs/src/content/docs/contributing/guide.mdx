...
meta:
  time: ~15 minutes
---
[Grepify](https://github.com/grepify/grepify) is an open source project. We are respectful, open and friendly. This guide explains how to get involved and contribute to [Grepify](https://github.com/grepify/grepify).

## Good first issues

We tag issues with the ["good first issue"](https://github.com/grepify/grepify/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) label for beginner contributors.
...
1. Fork the [Grepify repository](https://github.com/grepify/grepify)
