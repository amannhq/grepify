...
export const GET: APIRoute = async () => {
  ...
  const out: string[] = [
    '# Grepify Docs',
    '',
    '> Grepify is a lightweight code index for any harness, with built-in ' +
      'incremental processing. Declare what your target should look like ' +
    ...
    '',
    '> Coding agents: install the Grepify skill before writing v1 code — ' +
      SKILL_MD_URL +
