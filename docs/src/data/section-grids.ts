...
// component, imported directly in each section's index.mdx. Hrefs are
// absolute (`/docs/...`) so they work both from the rendered page and
// anywhere the data is reused.
import type { Props as DocCardGridProps } from '../components/DocCardGrid.astro';
...
export const programmingGuideGroups: SectionGridGroups = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        title: 'Target state',
        glyph: 'target',
        body: 'Declare what should exist in an external system and let Grepify sync minimal creates, updates, and deletes.',
      },
      {
