...
from grepify.ops.entity_resolution import (
    CanonicalSide,
    PairDecision,
    ResolutionEvent,
    resolve_entities,
...
DEFAULT_STATE_DIR = BENCH_ROOT / ".work" / "grepify"
...
def _load_litellm_embedder(model: str) -> Embedder:
    from grepify.ops.litellm import LiteLLMEmbedder
...
def _load_llm_resolver(
    *,
    ...
    from grepify.ops.entity_resolution.llm_resolver import LlmPairResolver
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run a synthetic benchmark for Grepify entity resolution."
    )
    parser.add_argument(
        "--profile",
...
async def run_benchmark(args: argparse.Namespace) -> dict[str, object]:
    ...
    os.environ.setdefault("GREPIFY_DB", str(args.state))
