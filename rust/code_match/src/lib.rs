//! `grepify_code_match` — match by-example structural patterns against
...
//! [`grepify_utils::error::Error::client`] via [`Pattern::compile`].
...
pub use grepify_utils::error::{Error, Result};
