...
```rust
use grepify_code_match::{lang, Pattern};
...
Parity with the grepify chunk splitter — each a one-line `LangConfig` constructor; the matcher and lexer are language-agnostic:
