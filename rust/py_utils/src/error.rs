use grepify_utils::error::{CError, CResult};
...
impl grepify_utils::error::HostError for HostedPyErr {
    ...
    fn try_clone(&self) -> Option<Box<dyn grepify_utils::error::HostError>> {
