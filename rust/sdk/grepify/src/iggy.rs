...
//!
//! Streams and topics are user-managed: Grepify never creates or drops them
...
//!
//! This is the Rust analogue of Python's `grepify.connectors.iggy` target,
...
/// `grepify::iggy::prelude::{StreamClient, TopicClient}`.
...
impl IggyTopicMap {
    ...
    fn consumer() -> Result<Consumer> {
        let id = Identifier::from_str_value("grepify")
