...
//!
//! Rust-native equivalent of Python's `grepify.ops.litellm`
...
/// `grepify.ops.entity_resolution.llm_resolver`. Python routes through
...
/// `grepify.ops.entity_resolution.LlmPairResolver`. The prompt and retry
