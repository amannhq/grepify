...
/// All errors produced by the grepify API.
#[derive(Debug, Error)]
pub enum Error {
...
/// Convert from grepify_utils::error::Error (used by core).
impl From<grepify_utils::error::Error> for Error {
    fn from(e: grepify_utils::error::Error) -> Self {
