...
//!
//! Mirrors Python's `grepify.resources.rate_limit.RateLimiter`. Throttles
...
//! limiter in `grepify_utils`.

use std::sync::Arc;
use std::time::Duration;

use grepify_utils::ratelimit::{RateLimit, RateLimiter as CoreRateLimiter};
