# Grepify Common Patterns

Common patterns and workflows for building Grepify pipelines.

## Core Pattern: TargetState = Transform(SourceState)

All Grepify pipelines follow this declarative pattern:

1. Read source state
2. Transform
3. Declare target state

Grepify handles the incremental sync automatically.
...
import grepify as coco
from grepify.connectors import kafka, lancedb
