# Grepify Connectors Reference

Comprehensive reference for all Grepify connectors.
...
Target connectors take a `ContextKey` (not the connection object directly) as their first argument. This enables Grepify to track the identity of the target across runs.
...
**Import**: `from grepify.connectors import postgres`
...
from grepify.connectors import postgres
...
**Import**: `from grepify.connectors import sqlite`
...
```python
from grepify.connectors import sqlite
...
**Import**: `from grepify.connectors import lancedb`
...
```python
from grepify.connectors import lancedb
...
**Import**: `from grepify.connectors import qdrant`
...
```python
from grepify.connectors import qdrant
...
**Import**: `from grepify.connectors import surrealdb`
...
```python
from grepify.connectors import surrealdb
...
**Import**: `from grepify.connectors import neo4j`
...
```python
from grepify.connectors import neo4j
...
**Import**: `from grepify.connectors import falkordb`
...
```python
from grepify.connectors import falkordb
...
**Import**: `from grepify.connectors import localfs`
...
from grepify.resources.file import PatternFilePathMatcher
...
**Import**: `from grepify.connectors import amazon_s3`
...
```python
from grepify.connectors import amazon_s3
...
**Import**: `from grepify.connectors import kafka`
...
from grepify.connectors import kafka
...
**Import**: `from grepify.connectors import doris`
...
```python
from grepify.connectors import doris
...
**Import**: `from grepify.connectors import google_drive`

**Capabilities**: Source only

```python
from grepify.connectors import google_drive
