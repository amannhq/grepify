...
//!   - walk / memo / mount_each / ContextKey      -> from `grepify`
//!   - tree-sitter chunking + language detection  -> `grepify::ops::text`
//!   - embeddings (all-MiniLM-L6-v2, local ONNX)  -> `grepify::ops::sentence_transformers`
//!   - Postgres/pgvector TableTarget sync          -> from `grepify`
