...
- Marketing-site diagrams under `grepify.github.io/` (different style, different primitives).
...
| Peach container with header | A Grepify App | `AppContainer` (slot in local coords) |
