#!/usr/bin/env bash
# preview.sh — build the Grepify docs site, serve it at the correct
...
#   - Run from the grepify repo root (cwd doesn't matter — paths resolve
...
# Resolve the grepify repo root relative to this script.
