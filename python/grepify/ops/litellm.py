...
from grepify.resources import schema as _schema
...
class LiteLLMEmbedder(_schema.VectorSchemaProvider):
    ...
    and automatically provides vector schema information for Grepify connectors.
...
class LiteLLMTranscriber:
    ...
    Example:
        >>> from grepify.ops.litellm import LiteLLMTranscriber
