...
<grepify.ops.text.RecursiveSplitter.split>`), prefilter-index term extraction
...
from grepify.resources import chunk as _chunk
from grepify.resources import view as _view
...
class CodeSource:
    ...
    <grepify.ops.text.RecursiveSplitter.split>`,
...
def render_match(source: "CodeSource", match: CodeMatch) -> _view.SourceView:
    ...
    The returned :class:`~grepify.resources.view.SourceView` carries synthetic
