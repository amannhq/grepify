...
def canonical_module_name(obj: typing.Any) -> str:
    ...
    * ``grepify update main.py`` -> ``main`` (basename, set by the loader)
    * ``grepify update main``    -> ``main`` (importlib's module name)
...
def fingerprint_call(
    ...
    *,
    ...
    Returns a `grepify._internal.core.Fingerprint` object (Python wrapper around a
