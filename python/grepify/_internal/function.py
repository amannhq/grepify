...
from grepify._internal.environment import Environment, get_event_loop_or_default
...
if TYPE_CHECKING:
    ...
    class _AsyncBatchedDecorator(Protocol):
        """Protocol for batched function decorator used by @grepify.function.

        Only accepts async underlying functions, since @grepify.function preserves
...
class _FunctionDecorator:
    ...
    def __call__(  # type: ignore[misc]
        ...
        *,
        ...
        """Decorator for Grepify functions (exposed as @coco.fn).
    ...
    def as_async(  # type: ignore[misc]
        ...
        *,
        ...
        """Decorator for Grepify functions (exposed as @coco.fn.as_async).
