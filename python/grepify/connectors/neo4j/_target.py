...
try:
    ...
    raise ImportError(
        "neo4j is required to use the Neo4j connector. Please install grepify[neo4j]."
    ) from e
...
class Neo4jType(NamedTuple):
    ...
    Use with ``typing.Annotated``::
        ...
        from grepify.connectors.neo4j import Neo4jType
...
_table_provider = coco.register_root_target_states_provider(
    "grepify/neo4j/table", _TableHandler()
)
