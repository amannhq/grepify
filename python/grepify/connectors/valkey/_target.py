"""Valkey target for Grepify (vector search via FT.CREATE / FT.SEARCH)."""
...
_index_provider = coco.register_root_target_states_provider(
    "grepify/valkey/index", _IndexHandler()
)
...
def create_client_config(
    ...
    *,
    ...
    use_tls: bool = False,
    client_name: str | None = "grepify_vector_store",
    **kwargs: Any,
