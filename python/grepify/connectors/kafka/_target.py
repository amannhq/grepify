...
_topic_provider = coco.register_root_target_states_provider(
    "grepify/kafka/topic", _TopicHandler()
)
...
class KafkaTopicTarget(
    ...
    The topic is user-managed (Grepify does not create/drop topics).
    ...
    def declare_target_state(
        ...
        On commit, Grepify will produce a message with the given key and value
