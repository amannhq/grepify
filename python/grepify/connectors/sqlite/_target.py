...
from grepify._internal.rwlock import RWLock
import msgspec
...
class SqliteType(NamedTuple):
    ...
    from grepify.connectors.sqlite import SqliteType
...
_table_provider = coco.register_root_target_states_provider(
    "grepify/sqlite/table", _TableHandler()
)
...
def connect(
    ...
    **kwargs: Any,
    ...
    """
    Create a SQLite connection with common defaults for Grepify.
