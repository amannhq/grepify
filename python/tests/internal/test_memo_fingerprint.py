...
from grepify._internal.function import _apply_memo_key, _normalize_memo_key
from grepify._internal.memo_fingerprint import (
    fingerprint_call,
    register_memo_key_function,
    unregister_memo_key_function,
)
from grepify._internal.typing import MemoStateOutcome
...
def test_state_methods_collected_from_hook() -> None:
    ...
    from grepify._internal.memo_fingerprint import StateFnEntry
