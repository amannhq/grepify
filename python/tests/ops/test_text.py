"""Tests for grepify.ops.text module."""

from grepify.ops.text import (
    detect_code_language,
    SeparatorSplitter,
    CustomLanguageConfig,
    RecursiveSplitter,
)
from grepify.resources.chunk import Chunk, TextPosition
...
def test_recursive_splitter_accepts_code_source() -> None:
    from grepify.ops.code import CodeSource
