"""Tests for grepify.ops.code module."""

import pytest

from pathlib import Path

from grepify.ops.code import (
    CodeMatch,
    CodePattern,
    CodeSource,
    index_terms,
...
def test_deprecated_codeast_compat_shims(tmp_path: Path) -> None:
    ...
    grepify-code's grep) still touch keeps working for one deprecation
    ...
    from grepify.ops import code as code_module
