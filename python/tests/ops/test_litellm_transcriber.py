...
from grepify.ops.litellm import LiteLLMTranscriber  # noqa: E402
from grepify.resources.file import FileLike  # noqa: E402
...
async def test_litellm_transcriber_reads_file_and_merges_kwargs() -> None:
    ...
    with patch(
        "grepify.ops.litellm.litellm.atranscription",
