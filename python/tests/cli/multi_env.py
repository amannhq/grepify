...
This tests the ls output grouping when both envs use 'grepify.db' but in different paths:
  ./db1/grepify.db:
    App1
  ./db2/grepify.db:
    App2
...
from grepify.connectors.localfs import declare_dir_target

_HERE = pathlib.Path(__file__).resolve().parent

# Two different directories, both using grepify.db as the filename
DB_DIR_1 = _HERE / "db1"
DB_DIR_2 = _HERE / "db2"
DB_PATH_1 = DB_DIR_1 / "grepify.db"
DB_PATH_2 = DB_DIR_2 / "grepify.db"
