"""Tests for serialization/deserialization in grepify._internal.serde."""
...
from grepify._internal.serde import (
...
class TestRejection:
    def test_unregistered_type_rejected(self) -> None:
        from grepify._internal.serde import DeserializationError
...
class TestInternalUnpickleSafeGlobal:
    ...
    def test_add_unpickle_safe_global(self) -> None:
        ...
        from grepify._internal.serde import _UNPICKLE_SAFE_GLOBALS
