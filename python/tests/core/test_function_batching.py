...
from grepify._internal.runner import Runner
import pytest
...
async def test_batching_out_of_component() -> None:
    """Test that batched functions work outside of Grepify app."""
...
# ============================================================================
# GPU Runner tests (in-process by default, subprocess with GREPIFY_RUN_GPU_IN_SUBPROCESS=1)
#
...
# --- Subprocess mode tests (GREPIFY_RUN_GPU_IN_SUBPROCESS=1) ---
...
async def test_gpu_runner_subprocess_basic(
    ...
    monkeypatch.setenv("GREPIFY_RUN_GPU_IN_SUBPROCESS", "1")
...
async def test_gpu_runner_lazy_env_var(
    ...
    monkeypatch.delenv("GREPIFY_RUN_GPU_IN_SUBPROCESS")
