...
from grepify.connectors.neo4j._cypher import (
...
if HAS_NEO4J:
    from grepify.connectors import neo4j as neo  # type: ignore[attr-defined]
...
def neo4j_uri_auth() -> Iterator[tuple[str, tuple[str, str]]]:
    ...
    container = Neo4jContainer(
        "neo4j:5.26-community", username="neo4j", password="grepify"
    )
    container.start()
    try:
