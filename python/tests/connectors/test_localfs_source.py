...
from grepify.connectors.localfs._common import FilePath, to_file_path
from grepify.connectors.localfs._source import _stat_to_metadata, DirWalker
...
class TestRescanInterval:
    ...
    def test_walk_dir_passes_rescan_interval(self, tmp_path: Path) -> None:
        from grepify.connectors.localfs._source import walk_dir
