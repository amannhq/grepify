...
from grepify.resources.file import FilePath
from grepify.connectors.localfs import FilePath as LocalfsFilePath
...
def test_localfs_has_no_register_base_dir() -> None:
    ...
    import grepify.connectors.localfs as localfs
