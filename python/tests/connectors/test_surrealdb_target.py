...
if HAS_SURREALDB:
    from grepify.connectors import surrealdb  # type: ignore[attr-defined]
    from grepify.connectors.surrealdb._target import (  # type: ignore[import-untyped]
        _format_record_id,
...
async def test_user_managed_table(
    ...
    """Test managed_by='user' — Grepify manages rows but not the table DDL."""
    conn, ns, db = surreal_conn
