...
class TestMemoization:
    ...
    async def test_memo_key_is_path_only(self) -> None:
        ...
        async with mock_aws():
            ...
            async with session.create_client("s3", region_name="us-east-1") as client:
                ...
                from grepify.resources.file import FileMetadata
    ...
    async def test_memo_state_first_run(self) -> None:
        ...
        async with mock_aws():
            ...
            async with session.create_client("s3", region_name="us-east-1") as client:
                ...
                outcome = await f.__coco_memo_state__(grepify.NON_EXISTENCE)

                assert isinstance(outcome, grepify.MemoStateOutcome)
    ...
    async def test_memo_state_unchanged(self) -> None:
        ...
        async with mock_aws():
            ...
            async with session.create_client("s3", region_name="us-east-1") as client:
                ...
                # Get initial state
                outcome1 = await f.__coco_memo_state__(grepify.NON_EXISTENCE)
    ...
    async def test_memo_state_serde_roundtrip(self) -> None:
        ...
        """
        import grepify
        from grepify._internal import serde
